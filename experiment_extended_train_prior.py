...
if __name__ == "__main__":
    ...
    data = pd.read_csv('{0}/cleaned_groceries.csv'.format(data_path_rules))
    ...
    rules = pd.read_csv('{0}/cleaned_groceries_rules.csv'.format(data_path_rules))
    ...
    np.savetxt("tmp/cleaned_groceries_statistics_5000_v2.csv", conf, delimiter=";")